  ...
  return (
    <section id="services" className="py-16 md:py-24 bg-secondary/20">
      <div className="container mx-auto px-4">
        {/* Section header */}
        <div className="mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Browse Our Services</h2>
          ...
          {MOCK_SERVICES.map((service) => (
            <Card key={service.id} className="overflow-hidden hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="p-5">
                ...
                <p className="text-sm text-foreground/60 mb-3">{service.provider}</p>
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm text-foreground/60">({service.reviews} reviews)</span>
                </div>
